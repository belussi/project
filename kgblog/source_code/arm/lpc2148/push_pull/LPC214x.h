...
#define ADCR_SEL0          (0x00000001)                  // Select channel 0
#define ADCR_SEL1          (0x00000002)                  // Select channel 1
#define ADCR_SEL2          (0x00000004)                  // Select channel 2
#define ADCR_SEL3          (0x00000008)                  // Select channel 3
#define ADCR_SEL4          (0x00000010)                  // Select channel 4
#define ADCR_SEL5          (0x00000020)                  // Select channel 5
#define ADCR_SEL6          (0x00000040)                  // Select channel 6
#define ADCR_SEL7          (0x00000080)                  // Select channel 7
#define ADCR_CLKS10    	   (0x00000000)                  // Use 10-bit conversions
#define ADCR_PDN      	   (0x00200000)                  // Whether AD is operational (1) or powered-down (0)
#define ADCR_CLKDIVSHIFT   (8)
#define ADCR_START_MASK    (0x07000000)
#define ADCR_START_NONE    (0x00000000)                  // No start (used when clearing PDN to 0)
#define ADCR_SELMASK       (0x000000ff)
#define ADCR_START_NOW     (0x01000000)                  // Start conversion now

#define ADDR_DONE          (0x80000000)                  // This bit is set to one when a conversion is complete
#define ADDR_RESULTMASK    (0x0000ffc0)
#define ADDR_RESULTSHIFT   (6)
/* D/A Converter */
